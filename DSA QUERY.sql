...
insert into DSA_Mall_Ikeja ( customerID,FirstName, lastname, Customer_gender, TransactionDate,address, transaction_amount)
values ( 570,'Femk', 'abdukl',  'male', '2025-05-01', '9 old road', 6685000.80),
   (571, 'isaiah', 'john','male', '2025-04-20', '22 alaly stree, okun', 99590.39),
    ( 572,'emma', 'abu','male', '2025-03-14', '7 ababa street, makunn', 66788.37),
	 (573, 'kara', 'ogun','female','2025-05-11', '10 hahroh road, ottawa', 3400.33),
	  ( 574,'sunkanmi', 'osagie', 'female','2025-02-10', '9 agric butstop street, okun', 89875.99),
	   (575,'oge', 'kunle', 'male','2025-02-21', '10 iwo street, liverpool', 7860.33),
	    (576, 'igbayin', 'elizabeth', 'female', '2025-04-15','100 kukuma street, epe', 89100.69)
...
---to get the details of the satff
...
select *
  CASE
	   ...
	   when Age between 36 and 49 then 'Senior Manager'
	   when Age between 26 and 35 then 'Manager'
	   when Age <= 25 then 'Executive Training'
	 Else 'Unknown'
End as [Age Group1]
from Employee
*/
